                  ...
                  <div className="shrink-0">
                    {item?.images && item.images.length > 0 ? (
                      <Image
                        ...
                        width={400}
                        height={400}
                        className="w-full  h-28 md:h-44 lg:w-28 lg:h-28 rounded-lg object-cover object-center"
                      />
                    ) : (
                      <div className="w-full h-28 md:h-44 lg:w-28 lg:h-28 bg-muted rounded-lg flex items-center justify-center text-muted-foreground border border-dashed">
