    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">
          All Completed Items ({activeCount})
        </h2>
      </div>
        ...
        <>
          <div className="space-y-4 grid grid-cols-2 lg:grid-cols-1 gap-2">
            {filteredItems.map((item: any) => (
              <Card key={item._id} className="p-2! lg:p-0 lg:px-2">
                <div className="flex lg:items-center gap-4 flex-col lg:flex-row">
                  <div className="shrink-0">
                    {item?.images && item.images.length > 0 ? (
                      <div className="w-full md:h-44 lg:w-32! h-32! rounded-lg flex items-center justify-center border overflow-hidden">
                        <Image
                      ...
                      <div className="w-full md:h-44 lg:w-32! h-32! bg-muted rounded-lg flex items-center justify-center text-muted-foreground border border-dashed">
                  ...
                  <div className="flex gap-2 flex-wrap sm:flex-nowrap sm:flex-col-reverse md:flex-row md:items-center justify-end">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full md:w-auto py-4 lg:py-6 lg:px-4! gap-1 text-white bg-[#00C950] rounded-xl hover:bg-[#00b448] hover:text-white!"
                    >
