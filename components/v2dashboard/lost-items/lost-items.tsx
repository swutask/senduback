              ...
              <div className="flex lg:items-center gap-4 flex-col lg:flex-row">
                ...
                <div className="shrink-0">
                  {item.images && item.images.length > 0 ? (
                    ...
                    <div className="w-full md:h-44 lg:w-32! h-32! aspect-square bg-muted rounded-lg flex items-center justify-center text-muted-foreground border border-dashed">
