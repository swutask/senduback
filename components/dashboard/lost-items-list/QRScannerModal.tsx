...
//         try {
//             const url = "https://yourapp.com/camera-upload";
...
//                 <Button className="sm:flex-none bg-[#0096FF] text-white hover:bg-blue-600 transition-colors py-2 px-6 rounded" onClick={() => setIsQRModalOpen(true)}>
...
//                     <DialogHeader>
//                         <DialogTitle className="text-xl font-semibold text-[#3A3A3A]">Scan QR Code</DialogTitle>
//                     </DialogHeader>

//                     <div className="space-y-6 py-4">
//                         <p className="text-sm text-[#7C8493] text-center">Scan the following QR from a device with a camera to take a photo of the item</p>
...
//                                     {qrCodeUrl ? (
//                                         <img src={qrCodeUrl} alt="QR Code" className="w-48 h-48 mx-auto mb-2" />
//                                     ) : (
//                                         <div className="w-48 h-48 bg-white border border-gray-200 mx-auto mb-2 flex items-center justify-center">
...
//                     <div className="flex justify-center">
//                         <Button onClick={() => setIsQRModalOpen(false)} className="bg-[#0096FF] text-white hover:bg-blue-600 transition-colors py-2 px-8 rounded">
//                             Close
//                         </Button>
//                     </div>
//                 </DialogContent>
